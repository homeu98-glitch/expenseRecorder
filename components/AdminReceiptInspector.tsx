...
export function AdminReceiptInspector({ receiptId }: { receiptId: string }) {
    ...
    <div className="space-y-6">
      ...
      <section className="card space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest">輸入方式</div>
            <div className="font-bold">{getInputMethodLabel(data.input_method)}</div>
          </div>
        </div>
      </section>
